...
# Garante a cobertura de varas genéricas ("2ª Vara") e dos OFÍCIOS JUDICIAIS
# (comarcas pequenas de SP nomeiam a unidade como "Ofício Judicial", não "Vara"),
# mesmo que a config da UI seja restrita. A busca ampla retorna todas as
# unidades; is_organ_allowed descarta criminal/infância depois.
